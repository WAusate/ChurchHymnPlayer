...
export default function Admin() {
  ...
  const lastSync = firebaseService ? firebaseService.getLastSyncDate() : null;
  const hasOffline = firebaseService ? firebaseService.hasOfflineData() : false;
  ...
  return (
    <Layout title="Administração" showBackButton={true}>
      <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="text-sm text-gray-600">
                <p>
                  Status: {hasOffline ? '✅ Dados disponíveis offline' : '❌ Sem dados offline'}
                </p>
                {lastSync && (
                  <p>
                    Última sincronização: {lastSync.toLocaleDateString()} às {lastSync.toLocaleTimeString()}
                  </p>
                )}
                {!firebaseService && (
              ...
              <Button 
                ...
                disabled={isSyncing || !firebaseService}
              ...
              <div className="text-xs text-gray-500">
                <p>
                  A sincronização baixa todos os hinos do Firebase para uso offline.
                  Isso permitirá que o app funcione mesmo sem conexão à internet.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-church-primary">Como Configurar o Firebase</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="text-sm text-gray-700">
              <h4 className="font-semibold mb-2">1. Criar projeto no Firebase:</h4>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Acesse <a href="https://console.firebase.google.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">console.firebase.google.com</a></li>
            ...
            <div className="text-sm text-gray-700">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>As credenciais ficam em: Configurações do Projeto → Geral → Seus apps</li>
              </ul>
            </div>
            ...
            <div className="text-sm text-gray-700">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Coleção: <code className="bg-gray-100 px-1 rounded">hinos</code></li>
                <li>Campos: numero (int), titulo (string), orgao (string), audioPath (string), criadoEm (timestamp)</li>
              </ul>
            </div>
            ...
            <div className="text-sm text-gray-700">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Pasta: <code className="bg-gray-100 px-1 rounded">hinos/</code></li>
                <li>Arquivos de áudio serão salvos automaticamente nesta pasta</li>
              </ul>
            </div>
          </CardContent>
        </Card>
